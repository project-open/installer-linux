...
NSF_SRC_DIR='/usr/local/src/nsf2.0.0'

# shared and unshared library suffix
NSF_SHARED_LIB_SUFFIX=2.0.0.so
NSF_UNSHARED_LIB_SUFFIX=2.0.0.a

# the shell in whose installation dirs the nsf package is installed
NSF_COMPATIBLE_TCLSH=/usr/local/ns/bin/tclsh8.5
