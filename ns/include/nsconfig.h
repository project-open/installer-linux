...
/* Define to 1 if crypt_r is available. */
/* #undef HAVE_CRYPT_R */
...
#define PACKAGE_STRING "NaviServer 4.99.8"

/* Revision number form souce code management system, or a constant from tar
   distribution */
#define PACKAGE_TAG "tar-4.99.8"
